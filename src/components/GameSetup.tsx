  ...
  return (
    <div className="max-w-md mx-auto bg-white dark:bg-gray-800 p-6 rounded-lg shadow-md dark:text-white">
      ...
      <form onSubmit={handleSubmit}>
        <div className="mb-4">
          <label htmlFor="player1" className="block text-gray-700 dark:text-gray-300 font-medium mb-2">
            Player 1
          </label>
          <input
            type="text"
        ...
        <div className="mb-4">
          <label htmlFor="player2" className="block text-gray-700 dark:text-gray-300 font-medium mb-2">
            Player 2
          </label>
          <input
            type="text"
        ...
        <div className="mb-6">
          <label htmlFor="player1TargetScore" className="block text-gray-700 dark:text-gray-300 font-medium mb-2">
        ...
        <div className="mb-6">
          <label htmlFor="player2TargetScore" className="block text-gray-700 dark:text-gray-300 font-medium mb-2">
